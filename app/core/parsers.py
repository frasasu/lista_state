class Parser:
    def __init__(self, tokens):
        ...
        self.function_types = [
            ...
            'T_TEST', 'T_TEST_INDEPENDENT', 'ANOVA', 'CHI2', 'MANN_WHITNEY', 'KRUSKAL',
            ...
            'F_TEST', 'SHAPIRO', 'SHAPIRO_WILK', 'ANDERSON', 'ANDERSON_DARLING',

            # FONCTIONS DE DISTANCE
            'EUCLIDEAN', 'MANHATTAN', 'COSINE', 'JACCARD', 'MINKOWSKI',

            # MOYENNES SPÉCIALISÉES ET DISPERSION (édition Pro)
            'GEOMETRIC_MEAN', 'HARMONIC_MEAN', 'QUADRATIC_MEAN', 'WEIGHTED_MEAN',
            'TRIMMED_MEAN', 'MIDRANGE', 'VARIANCE', 'RANGE', 'IQR', 'MAD', 'CV',

            # CORRÉLATIONS NON PARAMÉTRIQUES ET MATRICES
            'SPEARMAN', 'KENDALL', 'COVARIANCE_MATRIX', 'CORRELATION_MATRIX',

            # NORMALISATION / SCORE ET RÉ-ÉCHANTILLONNAGE
            'ZSCORE', 'ROBUST_SCALE', 'PERCENTILE_RANK', 'BOOTSTRAP', 'JACKKNIFE',
